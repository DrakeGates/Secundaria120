...
<html lang="en">
    ...
    <%if(h.getTipo().equals("Apoyo")){%>
<br><br><br><br>
    <div class="container">
        <div class="center">
            <h2><br>
                <%if(h.getSexo().equals("Masculino")){
                out.print("Bienvenido apoyo " + nombre);
            }else{
                if(h.getSexo().equals("Femenino")){
                    out.print("Bienvenida apoyo " + nombre);
                }else{
                    out.print("Bienvenid@ apoyo " + nombre);
                }
            }
            %>
            </h2><hr><br><br><br>
        ...
        <div class="row">
             <ul class="navbar-static-top text-center">
                 <form name="formu" action="Apoyo" method="post">
                     <input type="hidden" name="idApoyo" value="<%= id%>">
                     <input type="hidden" name="nombre" value="<%= nombre%>">
                     <input type="hidden" name="sexo" value="<%= sexo%>">
                     <input type="hidden" name="opc" id="opc" value="1">
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #4B0082" onclick="opc3()">Buscar Alumno</button>
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #FF4500" onclick="opc4()">Pase de lista</button>
                 </form>
             </ul>
        </div><br><br><br>
<br><br><br><br>
