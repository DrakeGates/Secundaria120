...
<html lang="en">
    ...
    <%if(h.getTipo().equals("Doctor")){%>
<br><br><br><br>
    <div class="container">
        <div class="center">
            <h2><br>
                <%if(h.getSexo().equals("Masculino")){
                out.print("Bienvenido médico " + nombre);
            }else{
                if(h.getSexo().equals("Femenino")){
                    out.print("Bienvenida médica " + nombre);
                }else{
                    out.print("Bienvenid@ médic@ " + nombre);
                }
            }
            %>
            </h2><hr><br><br><br>
        ...
        <div class="row">
             <ul class="navbar-static-top text-center">
                 <form name="formu" action="Doctor" method="post">
                     <input type="hidden" name="idDoctor" value="<%= id%>">
                     <input type="hidden" name="nombre" value="<%= nombre%>">
                     <input type="hidden" name="sexo" value="<%= sexo%>">
                     <input type="hidden" name="opc" id="opc" value="1">
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #5F9EA0" onclick="opc2()">Agregar incidencia</button>
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #57041B" onclick="opc3()">Buscar Alumno</button>
                 </form>
             </ul>
        </div><br><br><br>
<br><br><br><br>
