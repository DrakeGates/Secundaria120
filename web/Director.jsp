...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function opc7(){
                document.getElementById('opc').value=7;
                document.formu.submit();
            }
        </script>
    ...
    <%if(h.getTipo().equals("Director")){%>
    <br><br><br><br>
    <div class="container">
        <div class="center">
            <h2><br>
                <%if(h.getSexo().equals("Masculino")){
                out.print("Bienvenido Director " + nombre);
            }else{
                if(h.getSexo().equals("Femenino")){
                    out.print("Bienvenida Directora " + nombre);
                }else{
                    out.print("Bienvenid@ Director@ " + nombre);
                }
            }
            %>
            </h2><hr><br><br>
            <h2><a id="gototop" class="gototop" onclick="opc7()"> <i class="fa fa-exclamation-triangle"></i></a></h2>
            <br>
            <h2>
        ...
        <div class="row">
             <ul class="navbar-static-top text-center">
                 <form name="formu" action="Director" method="POST">
                     <input type="hidden" name="idDirector" value="<%= id%>">
                     <input type="hidden" name="nombre" value="<%= nombre%>">
                     <input type="hidden" name="sexo" value="<%= sexo%>">
                     <input type="hidden" name="opc" id="opc" value="1">
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #DC143C" onclick="opc3()">Publicar Aviso</button>
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #FF4500" onclick="opc6()">Puntualidad y Asistencia</button>
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #4B0082" onclick="opc5()">Buscar persona</button>
                 </form>
             </ul>
        </div><br><br><br>
        <br><br><br><br>
