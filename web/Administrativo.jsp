...
<html lang="en">
    ...
    <%if(h.getTipo().equals("Administrativo")){%>
<br><br><br><br>
    <div class="container">
        <div class="center">
            <h2><br>
                <%if(h.getSexo().equals("Masculino")){
                out.print("Bienvenido administrativo " + nombre);
            }else{
                if(h.getSexo().equals("Femenino")){
                    out.print("Bienvenida administrativa " + nombre);
                }else{
                    out.print("Bienvenid@ administrativ@ " + nombre);
                }
            }
            %>
            </h2><hr><br><br><br>
        ...
        <div class="row">
             <ul class="navbar-static-top text-center">
                 <form name="formu" action="Administrativo" method="post">
                     <input type="hidden" name="idAdministrativo" value="<%= id%>">
                     <input type="hidden" name="nombre" value="<%= nombre%>">
                     <input type="hidden" name="sexo" value="<%= sexo%>">
                     <input type="hidden" name="opc" id="opc" value="1">
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #4B0082" onclick="opc2()">Modificar datos de alguien</button>
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #006400" onclick="opc3()">Registrar Personal</button>
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #8B0000" onclick="opc4()">Eliminar alumno</button>
                 </form>
             </ul>
        </div><br><br><br>
<br><br><br><br>
