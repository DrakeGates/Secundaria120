...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function opc6(){
                document.getElementById('opc').value=6;
                document.formu.submit();
            }
        </script>
    ...
    <%if(h.getTipo().equals("Dios")){%>
<br><br><br><br>
    <div class="container">
        <div class="center">
            <h2><br>
                <%if(h.getSexo().equals("Masculino")){
                out.print("Bienvenido guapo e inteligente " + nombre);
            }else{
                if(h.getSexo().equals("Femenino")){
                    out.print("Bienvenida guapa e inteligente " + nombre);
                }else{
                    out.print("Bienvenid@ guap@ e inteligente " + nombre);
                }
            }
            %>
            </h2><hr><br><br><br>
        ...
        <div class="row">
             <ul class="navbar-static-top text-center">
                 <form name="formu" action="Dios" method="post">
                     <input type="hidden" name="idDios" value="<%= id%>">
                     <input type="hidden" name="nombre" value="<%= nombre%>">
                     <input type="hidden" name="sexo" value="<%= sexo%>">
                     <input type="hidden" name="opc" id="opc" value="1">
                     <button type="button" class="btn btn-primary btn-lg" required="required" onclick="opc2()">Borrar los alumnos de 3° Grado</button>
                     <button type="button" class="btn btn-primary btn-lg" required="required" onclick="opc3()">Borrar un usuario</button>
                     <button type="button" class="btn btn-primary btn-lg" required="required" onclick="opc4()">Borrar todas las incidencias</button>
                     <button type="button" class="btn btn-primary btn-lg" required="required" onclick="opc5()">Borrar todas las calificaciones</button>
                     <button type="button" class="btn btn-primary btn-lg" required="required" onclick="opc6()">Abrir o Cerrar las Inscripciones</button>
                 </form>
             </ul>
        </div><br><br><br>
<br><br><br><br>
